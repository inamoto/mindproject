...
@section('content')
                ...
                <script src="/mindproject/public/js/ganttlibs/jquery/jquery.livequery.1.1.1.min.js"></script>
                <script src="/mindproject/public/js/ganttlibs/jquery/jquery.timers.js"></script>
                <script src="/mindproject/public/js/ganttlibs/utilities.js"></script><!---->
                <script src="/mindproject/public/js/ganttlibs/forms.js"></script><!---->
                <script src="/mindproject/public/js/ganttlibs/date.js"></script>
                <script src="/mindproject/public/js/ganttlibs/dialogs.js"></script><!---->
                <script src="/mindproject/public/js/ganttlibs/layout.js"></script><!---->
                <script src="/mindproject/public/js/ganttlibs/i18nJs.js"></script>
                <script src="/mindproject/public/js/ganttlibs/jquery/dateField/jquery.dateField.js"></script>
                <script src="/mindproject/public/js/ganttlibs/jquery/JST/jquery.JST.js"></script>
                <script type="text/javascript" src="/mindproject/public/js/ganttlibs/jquery/svg/jquery.svg.min.js"></script><!---->
                <script type="text/javascript" src="/mindproject/public/js/ganttlibs/jquery/svg/jquery.svgdom.1.8.js"></script><!---->
                <script src="/mindproject/public/js/ganttUtilities.js"></script>
                <script src="/mindproject/public/js/ganttTask.js"></script>
                <script src="/mindproject/public/js/ganttDrawerSVG.js"></script>
                <script src="/mindproject/public/js/ganttGridEditor.js"></script>
                <script src="/mindproject/public/js/ganttMaster.js"></script>  
                <script src="/mindproject/public/js/gantt.temp.js"></script><!---->
